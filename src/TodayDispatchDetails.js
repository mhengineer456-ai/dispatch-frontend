  ...
  return (
    <div className="dispatch-modern-container">
      <div className="dispatch-modern-wrapper">
        ...
        {/* Today's Date & Actions Bar */}
        <div className="dispatch-modern-today-date" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '12px' }}>
          ...
          <div style={{ display: 'flex', gap: '10px' }}>
            ...
            >
              <span>📊</span>
              {generatingExcel ? 'Exporting...' : 'Export Today\'s Data (Excel)'}
            </button>
            <button
              onClick={generateSalesRegisterPDF}
              className="dispatch-modern-sales-register-btn"
              style={{
        ...
        <div className="dispatch-modern-stats-grid">
          <div className="dispatch-modern-stat-card">
            ...
            <div className="dispatch-modern-stat-info">
              <span className="dispatch-modern-stat-value">{todayStats.total}</span>
              <span className="dispatch-modern-stat-label">Today's Bills</span>
            </div>
          </div>

          <div className="dispatch-modern-stat-card">
            <div className="dispatch-modern-stat-icon dispatch-modern-stat-icon-purple" style={{ background: 'linear-gradient(135deg, #8b5cf6, #6d28d9)' }}>
              📦
            </div>
            <div className="dispatch-modern-stat-info">
              <span className="dispatch-modern-stat-value">
                {todayDispatches.reduce((sum, d) => sum + (parseInt(d.itemsCount) || 0), 0)}
              </span>
              <span className="dispatch-modern-stat-label">Total Items</span>
            </div>
          </div>
          ...
          <div className="dispatch-modern-stat-card">
            ...
            <div className="dispatch-modern-stat-info">
              <span className="dispatch-modern-stat-value">{todayStats.totalQuantity} <small style={{ fontSize: '13px', color: '#10b981' }}>PCS</small></span>
              <span className="dispatch-modern-stat-label">Total Quantity</span>
            </div>
          </div>
          ...
          <div className="dispatch-modern-stat-card">
            ...
            <div className="dispatch-modern-stat-info">
              <span className="dispatch-modern-stat-value">
                {todayDispatches.reduce((sum, d) => sum + (parseFloat(d.totalSets) || 0), 0)} <small style={{ fontSize: '13px', color: '#f59e0b' }}>Sets</small>
              </span>
              <span className="dispatch-modern-stat-label">
                + {todayDispatches.reduce((sum, d) => sum + (parseFloat(d.totalLoosePcs) || 0), 0)} Loose Pcs
              </span>
            </div>
          </div>
        </div>
